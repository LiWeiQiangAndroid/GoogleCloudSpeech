...
public class SecondSpeechService extends Service {
    ...
    public static SecondSpeechService from(IBinder binder) {
...
//                                .setLanguageCode(getDefaultLanguageCode())
    ...
    private class SpeechBinder extends Binder {
        ...
        SecondSpeechService getService() {
            return SecondSpeechService.this;
        }
